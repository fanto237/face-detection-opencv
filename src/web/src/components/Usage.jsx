...
function Usage() {
  return (
    <div className="mx-[35px] mb-8 md:mx-45 sm:mx-[50px]">
      <div className="flex flex-col items-center justify-center my-10">
        <h1 className="text-[#1bd4f1] text-3xl md:text-5xl ">
          Terms and Conditions
        </h1>
        <p className="text-[15px]">Last updated: January 09, 2023</p>
      ...
      <div className="">
        <h1 className="my-2 text-xl font-bold sm:my-4 sm:text-2xl md:text-3xl">
          Interpretation and Definitions
        </h1>
        <h2 className="text-[20px] sm:text-xl ">Interpretation</h2>
        ...
        <h2 className="text-[20px] sm:text-xl ">Definitions</h2>
        ...
        <ul>
          ...
          <li>
            <p>
              <strong>Country</strong> refers to: Bremen, Germany
            </p>
          </li>
          <li>
            <p>
              ...
              in this Agreement) refers to Meta Vision.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Meta Vision, accessible from{" "}
              <a
                href="metavision.com"
        ...
        <h2 className="text-[20px] sm:text-xl ">Severability</h2>
        <p>
        ...
        <h2 className="text-[20px] sm:text-xl ">Waiver</h2>
        <p>
